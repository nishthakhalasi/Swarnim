...
export default function LoginPage() {
  return (
    <div className="flex justify-center items-center">
      <Card className="absolute top-[200px]  w-[537px] h-[399.93px] p-[20px] gap-[10px] border-[#BFBFBF] rounded-[10px]  bg-white shadow-bottom-left">
            ...
            <div className="flex flex-col gap-6">
              <div className="grid gap-2">
                <Input
                  ...
                  required
                  className={` ${montserrat.className} w-[457px] h-[48.08px] px-[18px] py-[14px] gap-[10px]  font-normal text-[16px] leading-[100%] tracking-[0%] border border-[#BFBFBF] rounded-[2px] opacity-100 `}
                />
              </div>
              ...
              <div className="flex items-center w-[457px] h-[18.77px] justify-between mb-4">
        ...
        <CardFooter className="flex flex-col  gap-[8.14px]">
          <Button
            className={`${montserrat.className} w-[457px] h-[50px] p-[15px] rounded-[2px] bg-[#E0935A] border-none text-amber-50 font-bold text-[16px] leading-[100%] tracking-[0.02em] text-center uppercase`}
          >
            LOGIN
          </Button>
        </CardFooter>
