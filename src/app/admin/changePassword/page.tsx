  ...
  return (
    <>
      <div className="fixed inset-0 flex items-center justify-center bg-black/75 backdrop-blur-sm z-50">
        ...
        <Card className="relative w-full max-w-[507px] h-[360px] p-5 gap-6 bg-white rounded-none border-none mb-16">
          ...
          <CardContent className="flex flex-col justify-center items-center gap-4 ">
            <form>
              <PasswordInput
                className="w-full max-w-[540px] rounded-[2px]"
          ...
          <Button
            className={`${montserrat.className} w-full max-w-[507px] h-[50px] bg-gold text-amber-50 font-bold text-[16px] uppercase`}
          >
            SUBMIT
          </Button>
        </Card>
